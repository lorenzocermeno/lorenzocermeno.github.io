        ...
        <>
            ...
            <Grid2 container spacing={4} padding={4}>
                <Grid2 size={{sm: 4}} display={"flex"} justifyContent={"center"}>
                    <PortfolioCard title={"AI Hotel Booking Assistant"}
                ...
                <Grid2 size={{sm: 4}} display={"flex"} justifyContent={"center"}>
                    <PortfolioCard title={"POS Terminal Application"}
                                   ...
                                   repoLinks={<ImageLink
                                       ...
                                       width="2"
                                   />} chip={[{
                        image: <StyledImg src={rustLogo} alt="Rust logo" width="2"/>,
                        text: "Rust"
                    }]}/>
                </Grid2>
                <Grid2 size={{sm: 4}} display={"flex"} justifyContent={"center"}>
                    <PortfolioCard title={"Shoe (Brand) Size Converter"}
            ...
            <Grid2 container spacing={4} padding={4} justifyContent="center">
                <Grid2 size={{sm: 4}} display={"flex"} justifyContent={"center"}>
                    <PortfolioCard
                        title={"Digital Transformation Success Through Aligning the Organizational Structure: Case Study of Swedish Public Organizations"}
                        description={"AMCIS 2022 Proceedings. 10"} repoLinks={<ImageLink
                        id={"Globe (Internet)"}
