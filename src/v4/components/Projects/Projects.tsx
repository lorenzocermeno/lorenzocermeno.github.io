    ...
    return (
        <GridTabContentWrapper>
            ...
            <Project
                ...
                description="An application demonstrating the use of a chatbot, LangChain4j, to manage and perform hotel booking operations by textually interacting with the user."
                links={[
                    {
                        name: "Github",
